...
export default function OrphanageDetails() {
  ...
  const parms = route.params as OrphanegeRouteParms;
  api.get(`orphanages/${parms.id}`).then(response => {
  ...
  function handelOpenGoogleMapRoutes() {
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.mapContainer}>
          ...
          <TouchableOpacity onPress={handelOpenGoogleMapRoutes} style={styles.routesContainer}>
